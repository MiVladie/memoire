export const JOI_CUSTOM_MESSAGES = {
	...
	'string.length': 'The length must be {{#limit}} characters long',
	'string.max': 'The length must be less than or equal to {{#limit}} characters long',
	'string.min': 'The length must be at least {{#limit}} characters long'
};
